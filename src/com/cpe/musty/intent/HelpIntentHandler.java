...
public class HelpIntentHandler implements IntentHandler {
	...
	public SpeechletResponse handle(Intent intent) {
		String speechOutput = "You can ask questions about minecraft such as, what's "
				+ "the recipe for a chest, or, you can say exit... " + "Now, what can I help you with?";
		String repromptText = "You can say things like, what's the recipe for a"
